...
Agentic shopping agents, like [ShopGuide](https://apps.shopify.com/die-ai-agent-official-app), treat your Shopify catalog as a living knowledge base. By plugging directly into the **Shopify Catalog API**, the agent doesn't just see a list of titles; it understands the intent behind the ingredients.
