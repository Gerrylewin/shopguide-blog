...
<p className="mt-3">
  <a
    ...
    className="text-primary-500 hover:text-primary-400 decoration-primary-500/60 inline underline"
  >
    Book a free consultation
  </a>
  : we'll walk through your existing chat flows, identify where you're losing buyers, and outline where an AI agent can start paying for itself without ripping out what already works.
</p>
