...
<div className="mt-4">
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="bg-primary-600 hover:bg-primary-500 focus:ring-primary-400/70 inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-semibold text-white shadow-[0_0_15px_rgba(46,154,179,0.35)] transition focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:outline-none"
  >
    Book a call
  </a>
</div>
