...
<div className="space-y-4">
  <h2 className="text-2xl font-bold">Want to see what that could look like in your store?</h2>

<p className="mt-0">
  Book a consultation: We'll walk through your existing chat flows, identify where you're losing
  buyers, and outline where an AI agent can start paying for itself without ripping out what already
  works.
</p>
