...
<FAQSection
  items={[
    {
      question: 'Can the agent edit an order after it has been shipped?',
      answer:
    ...
    {
      question: 'How do I set the time limit for order edits?',
      answer:
    ...
    {
      question: 'Does the agent handle refunds autonomously?',
      answer:
    ...
    {
      question: 'What happens if a customer wants to swap for a more expensive item?',
      answer:
